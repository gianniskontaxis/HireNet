					...
					try {
						...
						for(int j=1; j<6; j++) {
							 if(rs.getString("Seminar" + j).equals("true")){
								 if(j==1) {
									model.addElement("You 've booked our Νο.1 Seminar");
								 }
								 else if (j==2){
									 model.addElement("You 've booked our Νο.2 Seminar");
								 }
								 else if (j==3){
									 model.addElement("You 've booked our Νο.3 Seminar");
								 }
								 else if (j==4){
									 model.addElement("You 've booked our Νο.4 Seminar");
								 }
								 else if (j==5){
									 model.addElement("You 've booked our Νο.5 Seminar");
								 }
								 else if (j==6){
									 model.addElement("You 've booked our Νο.6 Seminar");
								 }
